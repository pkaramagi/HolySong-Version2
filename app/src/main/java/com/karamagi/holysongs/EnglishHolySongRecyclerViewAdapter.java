...
import com.karamagi.holysongs.EnglishHolySongFragment.OnListFragmentInteractionListener;
 ...
 */
public class EnglishHolySongRecyclerViewAdapter extends RecyclerView.Adapter<EnglishHolySongRecyclerViewAdapter.ViewHolder> {

    private final List<HolySongItem> mValues;
    private final OnListFragmentInteractionListener mListener;
    private final ColorGenerator colorGenerator = ColorGenerator.MATERIAL;

    public EnglishHolySongRecyclerViewAdapter(List<HolySongItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_eglish_holysong, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("EXTRA_HOLYSONG_LG", "en");
